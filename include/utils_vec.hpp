...
void print_array(const double *a, int size, VectorOrientation o = VectorOrientation::COLUMN, std::string end = "\n");

// Print a 1D vector using std::vector
void print_vector(const std::vector<double> &v, VectorOrientation o = VectorOrientation::COLUMN, std::string end = "\n");
